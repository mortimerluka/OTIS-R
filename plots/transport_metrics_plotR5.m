...
function f = transport_metrics_plotR5(R1,R1_out)
%%
f=figure;
...
set(gca,'YAxisLocation','right')
arrow([1,max(log10(R1.T_S(:,5)))+4.5],[1,max(log10(R1.T_S(:,5)))+2.5],'Length',4,'Width',1,'TipAngle',45)
hold off 
...
xticklabels([])
set(gca,'TickDir','out');
arrow([1,max(log10(R1_out.T_S(:,2)))+2.5],[1,max(log10(R1_out.T_S(:,2)))+4.5],'Length',4,'Width',1,'TipAngle',45)
hold off
...
set(gca,'YAxisLocation','right')
arrow([1,max(log10(R1_out.T_S(:,3)))+4.5],[1,max(log10(R1_out.T_S(:,3)))+2.5],'Length',4,'Width',1,'TipAngle',45)
hold off 
