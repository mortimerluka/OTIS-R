...
function f = Rn290_plot(R1,R1_out)
%%
...
nexttile(tcl);
swarmchart(ones(2000,1),R1.TEMP_BTC_R290,'filled','MarkerFaceColor','k',SizeData = 5);
hold on
swarmchart(ones(2000,1)+1,R1.TEMP_BTC_R290_Qfix,'filled','MarkerFaceColor','k',SizeData = 5);
swarmchart(ones(2000,1)+2,R1_out.TEMP_BTC_R290,'filled','MarkerFaceColor','k',SizeData = 5);
