...
************************************************************************
     ...
     &                  LAMHAT2,CSBACK,DEPTH,PRODUCTION,GASEX)
...
*
     ...
     &                 CSBACK(MAXSEG,*),DEPTH(*),PRODUCTION(MAXSEG,*),
     &                 GASEX(MAXSEG,*)
*
*     Local variables
*
...
*
         B(1) = B(1) + LAMBDA(1,J)
*
*        contributions from the gas exchange term
*
*                - k/d C
*
         B(1) = B(1) + GASEX(1,J) / DEPTH(1)
*
