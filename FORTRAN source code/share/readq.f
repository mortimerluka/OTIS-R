...
*
*     QINVAL, CLVAL, QVALUE, AVALUE, DVALUE
*
************************************************************************
      SUBROUTINE READQ(QINVAL,CLVAL,QVALUE,AVALUE,NSOLUTE,NFLOW,DVALUE)
*
...
*
      ...
      DOUBLE PRECISION QINVAL(*),QVALUE(*),AVALUE(*),DVALUE(*),
     &                 CLVAL(MAXFLOWLOC+1,*)
*
*     local variables
*
...
*
      ...
      CALL GETLINE(LDFLOW,BUFFER)
      READ(BUFFER,1000) (DVALUE(I),I=1,NFLOW)
