...
************************************************************************
     ...
     &                   IGROUP,CLATIN,DEPTH,PRODUCTION,GASEX,PRODDT)
...
*
     ...
     &                 CLATIN(MAXSEG,*),PRODUCTION(MAXSEG,*),
     &                 GASEX(MAXSEG,*),PRODDT(MAXSEG,*)
*
...
*     undefined. (same is true for DEPTH and DEPTHN)
*
     ...
     &                 CSBACK,PRODUCTION,PRODDT)
         CALL PREPROC3(IMAX,DELTAX,Q,AREA,DEPTH,DFACE,QLATIN,HPLUSF,
     ...
     &                 LAMBDA,GASEX,SGROUP,BTERMS,BN,TGROUP,GAMMA,
     &                 IGROUP,QLATIN,CLATIN,AREA,CLATIN)
      ENDIF
*
