...
*
 ...
 2020 FORMAT(10X,'Locations at which Q is Specified',/,10X,33('-'),
     ...
     &       12X,'[L]',/,10X,78('-'))
 2040 FORMAT(8X,F12.3,1P,4(5X,E12.6))
...
*     concentrations, flow, area and depth values for each flow location.
*
      CALL READQ(QINVAL,CLVAL,QVALUE,AVALUE,NSOLUTE,NFLOW,DVALUE)
*
